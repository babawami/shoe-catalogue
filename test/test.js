describe(' Shoe Catalogue ', function() {
  ...
  it("Return Shoe/shoes that match the color selected", function() {
    ...
    assert.deepEqual(shoes.shoeMatch('white', '', null), [
      {color: 'white',brand: "adidas",price: 275,size: 10,in_stock: 3,id:1}
    ]);
  });
  ...
  it("Return Shoe/shoes that match the brand selected", function() {
    ...
    {color: "black", brand: "puma", price: 275, size: 9, in_stock: 3,id:4}
     ]);
  });
  ...
  it("Increase stock quantity when new shoe is added", function() {
    ...
    assert.deepEqual(shoes.addStock('white','adidas',10,280,10), [
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 5, id:0},
      {color: "white", brand: "adidas", price: 280, size: 10, in_stock: 13,id:1},
      {color: "brown", brand: "adidas", price: 350, size: 7, in_stock: 20,id:2},
      {color: "blue", brand: "reebok", price: 450, size: 6, in_stock: 15,id:3},
      {color: "black", brand: "puma", price: 275, size: 9, in_stock: 3,id:4}]);
  });
  ...
  it("Add shoe to cart", function() {
    ...
    assert.deepEqual(shoes.returnCart(), [
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 0,id:0},
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 0,id:0},
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 0,id:0},
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 0,id:0},
      {color: "blue", brand: "nike", price: 350, size: 7, in_stock: 0,id:0}
